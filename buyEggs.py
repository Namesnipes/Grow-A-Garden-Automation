...
from buy import buy, getMoneySymbol
...
def buyEggShop():
    ...
    sleep(1.8)  # Hold for 1.2 seconds
    ...
    if coords is not None:
        sleep(0.2)
        autoit.click_absolute(coords[0], coords[1])  # Click the money symbol to ensure we have enough money
